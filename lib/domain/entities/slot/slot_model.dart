...
import 'package:z1racing/domain/entities/slot/curve_model.dart';
import 'package:z1racing/domain/entities/slot/rect_model.dart';

enum TrackModelType { rect, curve }

enum TrackModelSensor { none, finish, sensor, start }
