...
class SubLapList extends PositionComponent with HasGameRef<Z1RacingGame> {
  ...
  Future<void> onLoad() async {
    await super.onLoad();
    void updateLapText() {
      if (GameRepositoryImpl().getCurrentLap() > 0) {
        _addTime();
      }
    }
